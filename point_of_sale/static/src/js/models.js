function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.PosModel = Backbone.Model.extend({
        ...
        models: [
        {
            ...
            model:  'res.partner',
            fields: ['name','ref','parent_id','street','city','state_id','country_id','vat','phone','zip','mobile','email','ean13','write_date'],
            ...
            model:  'pos.session',
            fields: ['id','journal_ids','taxes_ids','name','user_id','config_id','start_at','stop_at','sequence_number','login_number'],
            ...
            fields: ['display_name', 'list_price','price','pos_categ_id', 'taxes_id', 'ean13', 'default_code', 
                     ...
                     'product_tmpl_id', 'pos_taxes_ids', 'pos_taxes_category_ids'],
        ...
        load_new_partners: function(){
            ...
            var fields = find(this.models,function(model){ return model.model === 'res.partner'; }).fields;
        ...
        _save_to_server: function (orders, options) {
            ...
            //Modificacion Linea 627 
            var posOrderModel = new instance.web.Model('pos.order');
            var var_verify = 0;
            posOrderModel.call('check_availability',
                ...
                undefined,
                {
                    ...
                    if(var_verify !== 1){
                        ...
                        // throw "No hay disponibilidad para el producto: " + var_verify;
                        return False
                    }
            });
    ...
    module.Orderline = Backbone.Model.extend({
            ...
            _(taxes).each(function(tax) {
                if (tax.price_include) {
                    if (tax.type === "percent") {
                        ...
                        throw "El impuesto: " + tax.name + " de tipo " + tax.type + ", no es soportado por el punto de venta";
                    }
                } else {
                    if (tax.type === "percent") {
        ...
        get_all_prices: function(){
            ...
            try{product.pos_taxes_category_ids.length;}
            catch(error){product.pos_taxes_category_ids = [];}
            try{product.pos_taxes_ids.length;}
            catch(error){product.pos_taxes_ids = [];}
            if (product.pos_taxes_ids.length >= 1) {
                var taxes_ids = this.pos.config.taxes_ids.filter(value => -1 !== product.pos_taxes_ids.indexOf(value));
                //throw " producto " + taxes_ids + " txs " + product.pos_taxes_ids;
            } else if (product.pos_taxes_category_ids.length >= 1) {
                var taxes_ids = this.pos.config.taxes_ids.filter(value => -1 !== product.pos_taxes_category_ids.indexOf(value));
                //throw " categoria " + product.pos_taxes_category_ids + " txs " + taxes_ids;
            } else {
                //throw " txs " + product.pos_taxes_ids;
                var taxes_ids = [];
            }
