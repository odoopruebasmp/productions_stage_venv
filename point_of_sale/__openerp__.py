...
===========================
This module is based on original point of sale from odoo, and it has been modify by avancys to fix special needs.
...
* Refund previous sales
    """,
    'author': 'OpenERP SA - Avancys',
    'depends': ['product_category_taxes', 'partner_extended'],
    'data': [
