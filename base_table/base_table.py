...
class base_element(osv.osv):
    ...
    def element_exists(self, cr, uid, table_code, element_code, date=time.strftime('%Y-%m-%d'), context={}):
    ...
    def get_as_selection(self, cr, uid, table_code, date=time.strftime('%Y-%m-%d'), context=None):
    ...
    def get_selection(self, cr, uid, table_code, date=time.strftime('%Y-%m-%d'), context=None):
